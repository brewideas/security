package com.infius.proximitysecurity.custom;
...
public class CircularImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public void setCircularBorder(boolean circularBorder) {
        isCircularBorder = circularBorder;
    }
}
